...
- For every 0.01 increase in the probability of arrest, crime decreases by 0.062 crimes per person.
...
- For every 0.01 increase in probability of conviction, crime decreases by 0.021 crimes per person.
...
- For every 0.01 increase in probability arrest, crime rate decreases by 0.053.
- For every 1 additional person per square mile, crime increases by 0.0055 crimes per person.
...
- For every 0.01 increase in probability of conviction, crime decreases by 0.019 crimes per person
- For every 0.01 increase in young male population, crime increases by 0.092 crimes per person.

What is interesting here is that `pctymle` variable is now considered significant, unlike in model 2. This may be due to the nuances that the additional variables bring for the `pctymle` variable. 
